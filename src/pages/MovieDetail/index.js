        ...
        <div className="container">
            ...
            <>
                ...
                <div className="row my-5">
                    ...
                    <img src={movieDetail.poster_path?"https://image.tmdb.org/t/p/w600_and_h900_bestv2/"+movieDetail.poster_path:"https://underscoremusic.co.uk/site/wp-content/uploads/2014/05/no-poster.jpg"} alt="poster" width="300px" height="450px"></img>
                    </div>
                    <div className="col-lg-4">
                        <h3 className="mt-5" >{movieDetail.title||movieDetail.name}</h3>
            ...
            <div className="d-flex align-items-center" style={{height:'500px'}}>
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{margin: 'auto',background: 'none', display: 'block', shapeRendering: 'auto'}} width="50px" height="50px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                    <circle cx="50" cy="50" fill="none" stroke="#f7d603" stroke-width="10" r="35" stroke-dasharray="164.93361431346415 56.97787143782138" transform="rotate(13.2743 50 50)">
